	...
	$('#edit_recomendation_nav').click(function(){
			...
			//new
			view+="<div class='g_4'>";
			view+="<span class='t_48 mb_20' style='display: block;'>New</span>";
			view+="<ul id='content_new'>";
			view+="</ul>";
			view+="</div>";
			//top
			view+="<div class='g_4'>";
			view+="<span class='t_48 mb_20' style='display: block;'>Top</span>";
			view+="<ul id='content_top'></ul>";
			view+="</div>";
			//trending
			view+="<div class='g_4'>";
			view+="<span class='t_48 mb_20' style='display: block;'>Trending</span>";
		...
		$.ajax({
			...
			success: function(data){
				...
				for(var i = 0;i<length;i++){
					...
					list+="</div>";
					list+="<input type='button'  value ='Change' id='top_button' class='choose_but' style='margin:0px; float: left; margin-left:50px;'/>";
		...
		$.ajax({
			...
			success: function(data){
				...
				for(var i = 0;i<length;i++){
					...
					list+="</div>";
					list+="<input type='button'  value ='Change' id='trend_button' class='choose_but' style='margin:0px; float: left; margin-left:50px;'/>";
					list+="<input type='hidden' value="+i+" />";
					list+="<div class='clear'></div>";
					list+="</li>";
				}
